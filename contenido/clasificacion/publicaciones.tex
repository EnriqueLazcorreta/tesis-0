...
La Interacción Persona-Ordenador es una disciplina en la que se analizan muchos catálogos por lo que presentaremos nuestra aportación a esta rama de la ciencia en el \urlConNotaAlPie{http://interaccion2016.usal.es/}{Congreso Internacional Interacción'16}, que se celebrará en septiembre de 2016 en Salamanca, con la intención de encontrar investigadores que puedan utilizar nuestras propuestas para mejorar la calidad de los resultados que ya han obtenido y mejorar los tiempos de respuesta de sus experimentos.
