...
En \urlConNotaAlPie{http://interaccion2012.umh.es/}{Interacción'12} comenzamos a publicar nuestros resultados sobre las colecciones de \transacciones estructuradas mediante \datasets comprimidos. Los mayores avances los hemos obtenido este último año y estamos en un proceso actual de publicación de resultados en diversas revistas y un nuevo congreso internacional.
...
\addcontentsline{toc}{subsection}{Actas de Interacción'12}
\label{sec:clasificacion:publicaciones:interaccion-2012}
...
\descarga{https://www.researchgate.net/publication/266652926_Efficient_analysis_of_transactions_to_improve_Web_Recommendations}
\descarga{https://www.deepdyve.com/lp/association-for-computing-machinery/efficient-analysis-of-transactions-to-improve-web-recommendations-mBuBBNIv7c}
...
La Interacción Persona-Ordenador es una disciplina en la que se analizan muchos \catalogos por lo que presentaremos nuestra aportación a esta rama de la ciencia en el \urlConNotaAlPie{http://interaccion2016.usal.es/}{Congreso Internacional Interacción'16}, que se celebrará en septiembre de 2016 en Salamanca, con la intención de encontrar investigadores que puedan utilizar nuestras propuestas para mejorar la calidad de los resultados que ya han obtenido y mejorar los tiempos de respuesta de sus experimentos.
