...
\cite{DeshpandeKarypis-UsingConjunctionofAttributeValuesforClassification-2002}, proponen la "`conjunción de atributos"' para designar a un conjunto de pares \atributo=valor que mejoran el proceso de \Clasificacion. La notación usada en este artículo\ldots
