...
\begin{Definition}[\emph{Mapa de Navegación Web}]\label{def:1-3-1-MNW}
...
\begin{Definition}[\emph{Mapa Personal de Navegación Web}]\label{def:1-3-1-MPNW}
  \begin{equation}
     \label{eq:1-MPNW}
...
\begin{Definition}[\emph{Mapa de Uso del Sitio Web}]\label{def:1-3-1-MUSW}
