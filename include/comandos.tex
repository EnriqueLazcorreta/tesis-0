...
\newcommand{\logoGOOGLE}[1][7pt]{\includegraphics[height=#1]{logoGOOGLE}\xspace}
%Iconos y logos


\newcommand{\urlConNotaAlPie}[2]{\href{#1}{#2}\footnote{\scriptsize\url{#1}}}
...
\newcommand{\descargaCIO}[2][7pt]{%
  \href{#2}{\logoCIO[#1]}\footnote{\scriptsize\url{#2}}%
}
\newcommand{\descarga}[2][10pt]{%
  \href{#2}{\iconoDescarga[#1]}\footnote{\scriptsize\url{#2}}%
}
%\newcommand{\descargaRevisado}[2][10pt]{%
%  \href{#2}{\iconoDescarga[#1]}\footnote{\scriptsize\url{#2} \enlaceRevisado}%
%}
\newcommand{\visita}[2][10pt]{%
  \href{#2}{\iconoWWW[#1]}\footnote{\scriptsize\url{#2}}%
}
%\newcommand{\visitaRevisado}[2][10pt]{%
%  \href{#2}{\iconoWWW[#1]}\footnote{\scriptsize\url{#2} \enlaceRevisado}%
%}
...
\newcommand{\scopusConNotaAlPie}[2][9pt]{%
   \footnotesize%
   \href{#2}{\iconoSCOPUS}[#1]\footnote{\scriptsize\url{#2} Requiere acceso identificado.}%
}
\newcommand{\github}[2][10pt]{%
  \href{#2}{\logoGitHub[#1]}\footnote{\scriptsize\url{#2}}%
}
\newcommand{\google}[2][10pt]{%
  \href{http://lmgtfy.com/?q="#2"}{\logoGOOGLE[#1]}\footnote{\scriptsize\url{http://lmgtfy.com/?q="#2"}}%
}
% ! Enlaces para la bibliografía
