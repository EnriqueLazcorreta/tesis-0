...
\newcommand{\catalogo}{\emph{catálogo}\index{Catalogo@Catálogo}\xspace}
\newcommand{\Catalogo}{\emph{Catálogo}\index{Catalogo@Catálogo}\xspace}
\newcommand{\catalogos}{\emph{catálogos}\index{Catalogo@Catálogo}\xspace}
\newcommand{\Catalogos}{\emph{Catálogos}\index{Catalogo@Catálogo}\xspace}

   \newcommand{\mushroom}{\texttt{mushroom.dat}\index{Catalogo@Catálogo!mushroom}\xspace}
