...
\newcommand{\DM}{\emph{DM}\index{Minería de Datos (DM en inglés)}\xspace}
   ...
   \newcommand{\srw}{\emph{Sistemas de Recomendación Web}\index{Minería de Datos (DM en inglés)!Sistemas de Recomendación Web (SRW)}\xspace}
   \newcommand{\SRW}{\emph{SRW}\index{Minería de Datos (DM en inglés)!Sistemas de Recomendación Web (SRW)}\xspace}
