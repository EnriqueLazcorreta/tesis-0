...
\newcommand{\Clasificacion}{\emph{Clasificación}\index{Clasificación}\xspace}
   ...
   \newcommand{\cc{\emph{catálogo completo}\index{Clasificación!Catalogo@Catálogo Completo}\xspace}
   \newcommand{\CC}{\emph{Catálogo Completo}\index{Clasificación!Catalogo@Catálogo Completo}\xspace}
   \newcommand{\ccs{\emph{catálogos completos}\index{Clasificación!Catalogo@Catálogo Completo}\xspace}
   \newcommand{\CCs}{\emph{Catálogos Completos}\index{Clasificación!Catalogo@Catálogo Completo}\xspace}

      \newcommand{\mushroom}{\texttt{mushroom.dat}\index{Clasificación!Catalogo@Catálogo!mushroom}\xspace}
